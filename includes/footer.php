...
<div class="row">
<div class="col-md footer-nav-wrapper">
<ul class="footer-nav">
<li class="nav-item">
...
<li class="nav-item">
<a class="nav-link" href="application_services.php">
<span>Application Services</span>
</a>
</li>
<li class="nav-item">
<a class="nav-link" href="business_process_services.php">
<span>Business Process
Services</span>
</a>
</li>
<li class="nav-item">
<a class="nav-link" href="cloud_services.php">
<span>Cloud and Platform Services</span>
</a>
</li>
<li class="nav-item">
<a class="nav-link" href="consulting_services.php">
...
<li class="nav-item">
<a class="nav-link" href="life_sciences.php">
...
<li class="nav-item">
<a class="nav-link" href="travel_and_transportation.php">
...
<li class="nav-item">
<a class="nav-link" href="aerospace_defense.php">
...
<li class="nav-item">
<a class="nav-link" href="">Enterprise Technology Stack</a>
</li>
</ul>
</div>
...
<div id="newsletter-signup" class="form-wrapper">
<div class="container">
<div class="justify-content-center align-items-center">
<form class="form form-dark" novalidate data-form="animate" data-active-index="0" method="get"
action="" id="newsletter-signup-form">
...
<label class="sr-only">
Company</label>
<input class="form-control" type="text" name="Company" placeholder="Company"></input>
</div>
...
id="newsletter-signup_gdprCheck" required>
<label class="form-check-label" for="newsletter-signup_gdprCheck">
Yes, you can email me and process my data for marketing purposes. (
<a data-toggle="popover" data-php="true" data-placement="top"
...
<script type="text/javascript" src="asset/js/csc_contact_form-min.js"></script>
